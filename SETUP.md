...
```yaml
github_username: "Avinash-Jr"
display_name: "Avinash Kumar"
headline: "🚀 Building Scalable Systems & Real-Time Platforms"
tagline: "Full-Stack Engineer • Backend Specialist • Cloud Infrastructure"

# These lines rotate in an animated typing effect under your name
typing_lines:
  - "Building Scalable Web Systems"
  - "Full Stack Developer || SDE Backend"
  - "AWS & Microservice Archietecture"

bio: |
 I'm a Full-Stack Engineer with 2+ years of experience building production systems at scale. I specialize in backend architecture, real-time communication systems, and cloud infrastructure.

🏗️ Currently: Building scalable web applications with Node.js, React, and AWS — focused on microservices and real-time systems.
🔧 Backend Focus: Experienced in designing RESTful APIs, WebSocket/WebRTC systems, and multi-tenant SaaS platforms.
💼 Experience: Full-stack engineer at TheRegiment (client-facing dashboards), backend infra at Enveu (OTT video delivery).
🤝 Collaboration: Open to Backend SDE, and full-stack opportunities in product companies and startups.

links:
  linkedin: "https://www.linkedin.com/in/Avinashkumar"
  x: "https://x.com/your-handle"
  email: "your-avijr272@gmail.com"
  portfolio: "https://my-portfolio-beta-pink-71.vercel.app/"
